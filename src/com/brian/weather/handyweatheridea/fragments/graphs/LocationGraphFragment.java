...
public class LocationGraphFragment extends MainGraphFragment implements LocationListener {
	
	private LocationManager locationManager;

	private String provider;
	
	public static LocationGraphFragment newInstance() {
		return new LocationGraphFragment();
	}
	...
	private void currentLocationSet() {
		...
		if (location != null) {
			...
			OPEN_WEATHER_MAP_API = "http://api.openweathermap.org/data/2.5/forecast?%s&units=metric";
